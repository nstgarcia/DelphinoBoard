...
interrupt void TIMER1_ISR(void)
{
	...
	//Para el timer 1, el bit del IER es el 13. Se encuentra en la página 89 del manual técnico


		    GPIO_Toggle(12);//led red
...
interrupt void TIMER0_ISR(void)
{
    ...
    //We should write 1 to clear (acknowledge) the ISR to receive more interrupts
    PieCtrlRegs.PIEACK.all = PIEACK_GROUP1;  //0001
